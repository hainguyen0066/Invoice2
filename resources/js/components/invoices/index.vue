...
let invoices = ref([]);
let searchInvoicee = ref([]);

const getInvoices = async () => {
    let respone = await axios.get("/api/getAllInvoice");
...
const search = async () => {
    let respone = await axios.get(
        "/api/serachInvoice?s=" + searchInvoicee.value
    );
        ...
        <div class="invoices">
            ...
            <div class="table card__content">
                ...
                <div class="table--search">
                    ...
                    <div class="relative">
                        <i
                            class="table--search--input--icon fas fa-search "
                        ></i>
                        <input
                            class="table--search--input"
                            type="text"
                            placeholder="Search invoice"
                            v-model="searchInvoicee"
                            @keyup="search()"
                        />
                    </div>
                </div>
